...
import AccountStatementSearch from './AccountStatementSearch'
...
export default function AccountStatement ({ apitoken, auth, affiliates })
{
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="text-gray-900">
                            { !errMessage && !loading &&
                                ...
                                <AccountStatementTable prepaid={ prepaid } />
