...
import UserStatus from '@/Pages/Users/Partials/UserStatus';
import AccessDetails from '@/Pages/Users/Partials/AccessDetails';
import CustomerInformation from '@/Pages/Users/Partials/CustomerInformation';
import Security from '@/Pages/Users/Partials/Security';
import AccountingInformation from '@/Pages/Users/Partials/AccountingInformation';
import Alert from '../../Components/DaisyUI/Alert';
import Loading from '../../Components/DaisyUI/Loading';

export default function Details({ auth, apitoken, accountTypes, response_data }) {
    ...
    useEffect(() => {
        ...
        response_data ? setUserData({ user: response_data, errMessage: '', loading: false }) :
            setUserData({ user: null, errMessage: 'Something went wrong', loading: false })

        console.log("detail => ", response_data);
