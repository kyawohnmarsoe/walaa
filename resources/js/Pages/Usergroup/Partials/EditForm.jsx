...
export default function EditForm({ className = '', usergroup }) {
    ...
    function handleSubmit(e) {
        e.preventDefault()
        router.post(`/usergroup/${usergroup.id}`, values)
    }
    ...
    return (
        <section className={className}>
            ...
            <header>
                <h2 className="text-lg font-medium text-sky-600">Edit User Group</h2>
            </header>
