...
export default function Towers({ auth, towers, tower, show_data }) {
    ...
    const handleSearch = (ev) => {
        ...
        if (search_val !== '') {
            const filterdata = towers.filter((item) => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">Towers</h2>
            }
        >
            <Head title="Towers" />
