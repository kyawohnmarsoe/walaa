...
export default function EditForm({ className = '', tower }) {

    const { data, setData, post, processing, errors, reset } = useForm({
        tower_name: tower.tower_name,
        ip_address: tower.ip_address ?? '',
        rent_price: tower.rent_price ?? '',
        electric_price: tower.electric_price ?? '',
        line_price: tower.line_price ?? '',
        address: tower.address ?? '',
        latitude: tower.latitude ?? '',
        longitude: tower.longitude ?? '',
        owner_name: tower.owner_name ?? '',
        mobile_number: tower.mobile_number ?? '',
        mobile_number2: tower.mobile_number2 ?? '',
        notes: tower.notes ?? '',
        tower_status: tower.tower_status
    });
    ...
    const handleSubmit = (e) => {
        ...
        post(route('towers.update', tower.id));
    };
    ...
    return (
        <section className={className}>
            ...
            <header>
                <h2 className="text-lg font-medium text-sky-600">Edit Tower</h2>
            </header>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6 ">
                ...
                <div className='grid grid-cols-3 gap-8'>
                    <div>
                        <InputLabel htmlFor="tower_name" value="Tower Name" />
                        <TextInput
                            id="tower_name"
                            name="tower_name"
                    ...
                    <div>
                        <InputLabel htmlFor="tower_status" value="Up / Down Status" />
                        <SelectOption
                            id="tower_status"
                            className="mt-1 block w-full"
