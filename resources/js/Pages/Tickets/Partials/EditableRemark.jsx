...
export default function EditableRemark({ initialText, remarkId }) {
    ...
    const handleBlur = () => {
        ...
        router.post(`/tickets/update/remark/${remarkId}`, text);
        // console.log(remarkId)
        // console.log(text.remarks)
    };

    return (
        <div contenteditable="true" onDoubleClick={handleDoubleClick} className='flex'>
