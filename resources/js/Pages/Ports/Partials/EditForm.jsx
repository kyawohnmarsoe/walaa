...
export default function EditForm({ className = '', port, devices }) {
    ...
    const { data, setData, post, processing, errors, reset } = useForm({
        ...
        no_of_clients: port.no_of_clients ?? '',
        notes: port.notes ?? '',
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('ports.update', port.id));
    };
    ...
    return (
        <section className={className}>
            ...
            <header>
                <h2 className="text-lg font-medium text-sky-600">Edit Port</h2>
            </header>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6 ">
                ...
                <div className='grid grid-cols-3 gap-8'>
                    ...
                    <div>
                        <InputLabel htmlFor="port_status" value="Up / Down Status" />
                        <SelectOption
                            id="port_status"
                            className="mt-1 block w-full"
