...
export default function PaymentTableRow ({ item, apitoken, auth })
{
    ...
    return (
        ...
        <tr >
            ...
            <td>{ item?.recordDate }</td>
                <td> { item?.invoiceStatus == 'NotPaid' && <><button className="btn btn-xs btn-outline btn-block btn-info mb-1" onClick={ () => setModals({ setPayment :true}) } >Set Paid</button><br /></> }</td>
        </tr>
        </>
    )
}
