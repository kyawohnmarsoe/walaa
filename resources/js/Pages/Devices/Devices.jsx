...
export default function Devices({ auth, devices, towers, device, show_data }) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">Devices</h2>
            }
        >
            <Head title="Devices" />
