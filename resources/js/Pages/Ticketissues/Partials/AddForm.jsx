...
export default function AddForm({ className = '' }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('ticket.issues.store'));
    };
    ...
    return (
        <section className={className}>
            ...
            <header>
                <h2 className="text-lg font-medium text-sky-600">Add Issue</h2>
            </header>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-6 ">
                ...
                <div className='grid grid-cols-3 gap-4'>
                    <div>
                        <InputLabel htmlFor="issue_type" value="Issue Type" className='required' />
                        <TextInput
                            id="issue_type"
                            name="issue_type"
