...
export default function Ticketissues({ auth, issues, issue, show_data }) {
    ...
    const handleSearch = (ev) => {
        ...
        if (search_val !== '') {
            const filterdata = issues.filter((item) => {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={
                <h2 className="font-semibold text-xl text-gray-800 leading-tight">Ticket Issues</h2>
            }
        >
            <Head title="Ticket Issues" />
